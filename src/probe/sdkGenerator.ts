...
export async function generateSdk(args: {
  discoveredByCustomer: Record<string, any>;
}) {
  await fs.mkdir("generated", { recursive: true });
  await fs.writeFile("generated/manifest.json", JSON.stringify(args.discoveredByCustomer, null, 2), "utf-8");
...
`.trimStart();
  ...
  await fs.writeFile("generated/sdk.ts", sdkTs, "utf-8");
  console.log("[agent] ✅ SDK generated at generated/sdk.ts and generated/manifest.json");
}